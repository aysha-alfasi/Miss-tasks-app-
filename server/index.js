...
function generateResponseMessage(score, text) {
  ...
  // <♡ Arrays of possible phrases to check for />
  const phrases = [
  ...
  for (const helloPhrase of helloPhrases) {
    if (lowercasedText.includes(helloPhrase)) {
      return "Hello, how are you today? Please let me know about your progress 😊";
    }
  }
